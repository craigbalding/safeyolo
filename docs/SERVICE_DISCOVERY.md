...
2. Mount to `/safeyolo/data/services.yaml` in container
3. No CLI dependency
...
Located at `~/.safeyolo/data/services.yaml` (auto-generated by CLI) or mounted to `/safeyolo/data/services.yaml`.
...
Mount this file to `/safeyolo/data/services.yaml` when running the safeyolo container.
