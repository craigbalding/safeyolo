...
cancellation, streamed HTTP bodies and unsupported text codecs remain explicit
coverage limits. Full details and pinned data provenance are in the [engine
...
named-Unicode grammar, uncovered Unicode properties, streamed/unsupported HTTP
