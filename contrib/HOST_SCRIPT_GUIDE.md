...
`/safeyolo/skills/safeyolo-demo-lab`, and the `safeyolo-lab` guest command.
The helper refuses to overwrite a user-owned skill or command with a managed
name. Custom standalone scripts may instead stage their own instructions.
