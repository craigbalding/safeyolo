...
struct HeaderBlock {
    original_fields: crate::ext::OriginalHeaderFields,
...
impl Headers {
    ...
    pub(crate) fn take_original_fields(&mut self) -> crate::ext::OriginalHeaderFields {
        std::mem::take(&mut self.header_block.original_fields)
    }
                ...
                Field { name, value } => {
                        ...
                        || name == "proxy-connection"
                    {
                        ...
                        if !self.is_over_size {
                            ...
                            self.original_fields.0.push((name.clone(), value.clone()));
