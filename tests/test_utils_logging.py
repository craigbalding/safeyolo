...
class TestWriteEvent:
    ...
    def temp_log(self, tmp_path):
        ...
        with patch("safeyolo.core.utils.AUDIT_LOG_PATH", log_path):
            yield log_path
    ...
    def test_writes_valid_json(self, temp_log):
        ...
        with patch("safeyolo.core.utils.AUDIT_LOG_PATH", temp_log):
            write_event(
                "traffic.request",
    ...
    def test_creates_parent_directory(self, tmp_path):
        ...
        with patch("safeyolo.core.utils.AUDIT_LOG_PATH", nested_path):
            write_event("traffic.request", kind=EventKind.TRAFFIC, severity=Severity.LOW, summary="test")
            _drain_audit()
...
class TestConfigureFileLogging:
    ...
    def test_creates_log_directory(self, tmp_path):
        ...
        from safeyolo.core.utils import configure_file_logging
